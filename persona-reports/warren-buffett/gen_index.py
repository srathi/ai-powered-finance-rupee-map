#!/usr/bin/env python3
"""Automated Warren Buffett-style equity-screen report generator for NSE indices.

Fetches live financials via yfinance, runs the Warren Buffett fatal-flaw framework,
