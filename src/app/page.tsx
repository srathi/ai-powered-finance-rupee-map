...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="px-6 py-4">
        <div className="max-w-[1440px] mx-auto">
          <div className="rounded-2xl bg-gradient-to-br from-amber-500/10 via-primary/5 to-transparent border border-amber-500/10 p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500/20 to-primary/20 flex items-center justify-center">
                    <span className="text-2xl">📄</span>
                  </div>
                  <div>
                    <h2 className="text-2xl md:text-3xl font-bold">
                      <span className="text-on-surface">Persona </span>
                ...
                <p className="text-on-surface-variant mb-6 max-w-lg">
                  Pick a stock and an investor — Buffett, Lynch, Greenblatt and
                  more — and get a branded PDF report written in their voice
                  from live market data.
                </p>
                <Link href="/stock-report">
                  <Button
                    size="lg"
                    className="gap-2 bg-gradient-to-r from-amber-500 to-primary text-white hover:opacity-90"
                  >
                    Generate Reports
                    <ArrowRight className="h-4 w-4" />
                  </Button>
              ...
              <div className="hidden md:block w-64 shrink-0">
                <div className="space-y-3">
                  {[
                    ...
                    "Value pick like Greenblatt?",
                    "Lynch fatal-flaw check?",
                  ].map((q, i) => (
                    <div
                      key={i}
                      className="px-4 py-2.5 rounded-xl bg-surface-container-high/50 border border-border/30 text-sm text-muted-foreground"
